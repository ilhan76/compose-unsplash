...
import ru.surf.users.data.dao.UserModelDao_Impl;
...
public final class UsersDatabase_Impl extends UsersDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `UserModel` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'c23f52f7c7a598c96fe213c862d91300')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsUserModel = new HashMap<String, TableInfo.Column>(2);
        _columnsUserModel.put("id", new TableInfo.Column("id", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUserModel.put("name", new TableInfo.Column("name", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoUserModel.equals(_existingUserModel)) {
          return new RoomOpenHelper.ValidationResult(false, "UserModel(ru.surf.users.data.models.UserModel).\n"
                  + " Expected:\n" + _infoUserModel + "\n"
                  + " Found:\n" + _existingUserModel);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "c23f52f7c7a598c96fe213c862d91300", "2108389c94cff7b67934834c70a20430");
  ...
  @Override
  public UserModelDao daoUserModel() {
